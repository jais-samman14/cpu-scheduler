...
export default function SJF() {
  ...
  const calculateSJF = () => {
    // Create a copy of processes and sort by arrival time then burst time
    const sortedProcesses = [...processes]
      .sort((a, b) => a.arrivalTime - b.arrivalTime || a.burstTime - b.burstTime);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        <h1 className="text-4xl font-bold text-center text-blue-800 mb-6">Shortest Job First (SJF) Scheduling</h1>
        
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Theory</h2>
          <p className="text-gray-700 mb-4">
            Shortest Job First (SJF) is a non-preemptive scheduling algorithm where the process 
            with the smallest burst time is selected for execution next. If two processes have the 
            same burst time, FCFS scheduling is used to break the tie.
          </p>
          
          <h3 className="text-xl font-semibold text-gray-800 mb-3">Advantages:</h3>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
            <li>Minimizes average waiting time for a given set of processes</li>
            <li>Optimal scheduling algorithm in terms of minimum average waiting time</li>
            <li>Better than FCFS scheduling in terms of throughput</li>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Difficult to know the burst time of processes in advance</li>
            <li>Can lead to starvation of longer processes (convoy effect)</li>
            <li>Not suitable for interactive systems</li>
            <li>Implementation requires advanced knowledge of CPU burst times</li>
          </ul>
        </div>
      </div>
      ...
      {results.length > 0 && (
        <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">SJF Scheduling Results</h2>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-purple-50 p-4 rounded">
              <h4 className="font-semibold text-purple-800">Throughput</h4>
            ...
            <div className="flex items-center space-x-1 mb-4">
              {ganttChart.map((block, index) => (
                <div key={index} className="flex flex-col items-center">
                  <div className="bg-blue-500 text-white px-3 py-2 rounded text-sm font-semibold min-w-[60px] text-center">
                    P{block.process}
                  </div>
